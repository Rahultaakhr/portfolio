        ...
        <footer>
            <div className=' text-center text-white font-semibold opacity-100 py-2'>
                <ul className='  flex gap-6 items-center justify-center text-xl md:text-4xl py-2 font-bold'>
                    ...
                    <li className=' bg-clip-text text-transparent bg-gradient-to-tr from-blue-400 via-blue-500 to-blue-500'><a href="https://www.linkedin.com/in/rahul-taak-hr" target='_blank'><i className="fa-brands fa-linkedin"></i></a></li>
                    <li className=' bg-clip-text text-transparent bg-gradient-to-br  from-gray-800 via-gray-900 to-gray-950'><a href="https://www.github.com/rahultaakhr" target='_blank'><i class="fa-brands fa-github"></i></a></li>
                </ul>
